    ...
    <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center lg:text-left">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-hockey-gray mb-8 max-w-2xl leading-relaxed">
          ...
          <Button 
            ...
            className="mb-4 mr-4 bg-hockey-black text-ice-white hover:bg-hockey-gray"
          >
            Apply Now 🏒
          </Button>
          
          <div className="flex items-center justify-center lg:justify-start gap-4 text-hockey-gray text-sm">
